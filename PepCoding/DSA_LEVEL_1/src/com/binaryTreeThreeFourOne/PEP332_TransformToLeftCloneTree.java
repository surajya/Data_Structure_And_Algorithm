...
public class PEP332_TransformToLeftCloneTree {
	...
	public static void transformToLeftCloneTree(Node node) {
		...
		Node copyLeftNode = new Node(node.data, childNode, null);
		node.leftNode = copyLeftNode;
		transformToLeftCloneTree(copyLeftNode.leftNode);
		transformToLeftCloneTree(node.rightNode);
	}
