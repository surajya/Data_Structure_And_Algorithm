...
public class PEP341_DiameterOfBinaryTree {
	...
	public static int diameterOfBinaryTree(Node root) {
		...
		int leftdia = diameterOfBinaryTree(root.leftNode);
		int rightdia = diameterOfBinaryTree(root.rightNode);
		if (leftdia + rightdia > dia) {
			dia = leftdia + rightdia;
		}
		return leftdia > rightdia ? leftdia + 1 : rightdia + 1;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("Diameter of Binary Tree : " + dia);
	}
}
