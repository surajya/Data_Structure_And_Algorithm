...
public class PEP177_MiddleLinkedList {
	...
	public static void main(String[] args) {
		...
		while (true) {
			System.out.println(
					"PLZ select the operation ->  1 : SIZE \t 2 : DISPLAY \t 3 : CreateLinkedList \t 4 : FindTheKthElementFromTheEndOfLInkedList \t 5 : MiddleOfLInkedList \t 0 : EXIT");
