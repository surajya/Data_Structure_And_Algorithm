...
public class PEP165_RemoveFromLastIndex {
	...
	public static void main(String[] args) {
		...
		while (true) {
			System.out.println(
					"PLZ select the operation ->  1 : SIZE \t 2 : DISPLAY \t 3 : ADD \t 4 : GetFirst  \t 5 : AddFirst  \t 6 : AddAtIndex \t 7 : GetLast \t 8 : GetAtIndex \t 9 : RemoveLastIndex \t 10 : RemoveAtIndex \t 0 : EXIT");
